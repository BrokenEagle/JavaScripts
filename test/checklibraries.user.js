...
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/load.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/concurrency.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/network.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/danbooru.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/saucenao.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/validate.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/utility.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/statistics.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/storage.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/library-version12/lib/debug.js
...
async function CheckLoadLibrary() {
    ...
    if (test_success) {
        console.log(`program load waiting on <badtag1> or <badtag2> should not have run`,RecordResult(JSPLib.load.program_load_timers.timer5 === false));
        console.log(`program load waiting on <badtag> or <badtag2> should have retried once [${JSPLib.load.program_load_retries.timer5}]`,RecordResult(JSPLib.load.program_load_retries.timer5 === 0));
    } else {
        RecordResult(test_success);
    }
    ...
    if (test_success) {
        console.log(`program load waiting on "window.goodvariable" should have run`,RecordResult(JSPLib.load.program_load_timers.timer6 === true));
        console.log(`program load waiting on "window.goodvariable" should have tried once [${JSPLib.load.program_load_retries.timer6}]`,RecordResult(JSPLib.load.program_load_retries.timer6 === 0));
    } else {
        RecordResult(test_success);
    }
