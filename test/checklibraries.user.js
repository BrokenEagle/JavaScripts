...
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/module.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/debug.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/notice.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/utility.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/storage.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/concurrency.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/statistics.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/validate.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/network.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/danbooru.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/saucenao.js
// @require      https://raw.githubusercontent.com/BrokenEagle/JavaScripts/2022-02-12/lib/load.js
...
async function CheckNetworkLibrary() {
    ...
    await JSPLib.network.getJSON(url1,addons1);
    ...
    url1 = "/static/contact";
    let options1 = null;
    let resp = JSPLib.network.get(url1, {}, null, 'html', {beforeSend: (jqXHR, settings)=>(options1 = settings)});
    let html = await resp;
    ...
    url1 = "/static/contact";
    options1 = null;
    resp = JSPLib.network.post(url1, {_method: 'get'}, null, 'html', {beforeSend: (jqXHR, settings)=>(options1 = settings)});
    html = await resp;
    $html = jQuery(html);
    ...
    url1 = "/posts/1.json";
    options1 = null;
    resp = JSPLib.network.getJSON(url1, {}, null, {beforeSend: (jqXHR, settings)=>(options1 = settings)});
    ...
    options1 = null;
    resp = JSPLib.network.getScript(url1, null, {beforeSend: (jqXHR, settings)=>(options1 = settings)});
    await resp;
...
async function CheckLoadLibrary() {
    ...
    if (test_success) {
        ...
        TestPrint("program load waiting on #id-doesnt-exist should have tries 2 times", JSPLib.load.program_load_retries.timer2, RecordResult(JSPLib.load.program_load_retries.timer2 === 2));
    } else {
        TestPrint("Loading failed", null, RecordResult(test_success), false);
    }
    ...
    if (test_success) {
        ...
        TestPrint("program load waiting on .class-doesnt-exist should have retried once", JSPLib.load.program_load_retries.timer3, RecordResult(JSPLib.load.program_load_retries.timer3 === 0));
    } else {
        TestPrint("Loading failed", null, RecordResult(test_success), false);
    }
    ...
    if (test_success) {
        ...
        TestPrint("program load waiting on <badtag> should have retried once", JSPLib.load.program_load_retries.timer4, RecordResult(JSPLib.load.program_load_retries.timer4 === 0));
    } else {
        TestPrint("Loading failed", null, RecordResult(test_success), false);
    }

    console.log("Starting program load with all bad optional selectors");
    JSPLib.load.programInitialize(function1,'timer5',[],[],['badtag1','badtag2'],0);
    ...
    if (test_success) {
        ...
        TestPrint("program load waiting on <badtag> or <badtag2> should have retried once", JSPLib.load.program_load_retries.timer5, RecordResult(JSPLib.load.program_load_retries.timer5 === 0));
    } else {
        TestPrint("Loading failed", null, RecordResult(test_success), false);
    }

    console.log("Starting good program load");
    JSPLib.load.programInitialize(function2,'timer6',['window.goodvariable'],['#id-does-exist','.class-does-exist','body'],['#c-static','#c-posts'],5);
