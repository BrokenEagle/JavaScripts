...
.ntisas-main-tweet .ntisas-image-section {
    font-size: 1.1em;
}
.ntisas-query-button {
    display: inline-block;
...
.ntisas-main-tweet .ntisas-query-button {
    margin: 0 -7px;
}
.ntisas-stream-tweet .ntisas-query-button {
    margin: 0 -6px 0 -5px;
}
...
.ntisas-stream-tweet .ntisas-download-section {
    margin-top: 0.4em;
}
.ntisas-main-tweet .ntisas-download-section {
    margin-top: 0.2em;
}
...
.ntisas-main-tweet .ntisas-tweet-header {
    padding: 5px 6px;
}
.ntisas-stream-tweet .ntisas-tweet-header {
    padding: 4px 6px;
}
.ntisas-tweet-header {
    font-family: ${FONT_FAMILY};
...
function RenderSimilarIDsLink(post_ids,similar_data,classname,type) {
    ...
    let idlink = `
<a
    class="ntisas-confirm-save ${classname} ntisas-expanded-link"
    data-type="${type}"
    target="_blank"
    title="${title}"
    href="${href}"
...
function InitializeImageTweets($image_tweets) {
    ...
    $process_tweets.each((i,tweet)=>{
        ...
        JSPLib.utility.recheckTimer({
            check: ()=>{
                return ['image', 'video'].includes(media_type) ||
...
function MarkupMainTweet(tweet) {
    ...
    do {
        ...
        let has_indicator = (retweetchild.querySelector('[href$="/retweets"]') !== null) ||
    ...
    do {
        ...
        let has_indicator = (actionchild.querySelector('[data-testid="reply"]') !== null) ||
