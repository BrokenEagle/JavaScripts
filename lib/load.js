...
JSPLib.load.exportData = function (program_name, program_value, other_data = null, datalist=[], programvariable = {}) {
    ...
    datalist.forEach((name)=>{
        Object.defineProperty(JSPLib._window_jsp.export[program_name], name, {get: () => programvariable[name]});
    });
};
