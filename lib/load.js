...
JSPLib.load.programInitialize = function (program,program_name,required_variables = [],required_selectors = [],max_retries = JSPLib.load._default_max_retries,timer_interval = JSPLib.load._default_timer_interval) {
...
JSPLib.load._configuration = {
    nonenumerable: ['_default_timer_interval','_default_max_retries','_isVariableDefined','_configuration'],
