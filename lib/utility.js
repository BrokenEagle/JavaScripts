...
JSPLib.utility.isScrolledIntoView = function (domnode,view_percentage=0.75) {
    ...
    let {top: elemTop} = JSPLib.utility.getElemPosition(domnode);
...
JSPLib.utility._hijackTime = function (key) {
    if (typeof key === "string") {
        let timer_key = key + '[' + JSPLib.utility.getUniqueID() + ']';
...
JSPLib.utility._configuration = {
    nonenumerable: ['_css_style','_css_sheet','_start_time','_setOperation','_makeSets','_makeArray','_orderSets','_orderArrays','_combineArgs','_getSelectorChecks','_isHash','_hijackTime','_hijackTimeEnd','_configuration'],
