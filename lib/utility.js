...
Utility.isID = function (value) {
    return Utility.isInteger(value) && (value > 0);
};

Utility.isIDList = function (array) {
    return Utility.isArray(array) && ((array.length === 0) || ((array.length > 0) && array.reduce((total, val) => Utility.isID(val) && total, true)));
};
