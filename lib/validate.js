...
validate.tag_categories = [0, 1, 3, 4, 5];
...
if ((typeof ValidateJS === 'function') && (typeof ValidateJS.validators === 'object')) {
    ...
    ValidateJS.validators.tagentryarray = function(value, options) {
        if (options !== false) {
            ...
            let categories = (validate.checkOptions(options, 'categories') ? options.categories : validate.tag_categories);
...
})(validate, JSPLib.debug, JSPLib.utility);
