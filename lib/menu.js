...
const SETTINGS_FIELD = JSPLib.utility.normalizeHTML()`
<div id="userscript-settings-menu" class="tab-panel-component horizontal-tab-panel fixed-width-container" x-data="{ active: 0 }" style="display: none;" data-version="${JSPLib.menu.version}">
    <div class="tab-list thin-x-scrollbar">
        <a x-on:click.prevent="active = 0" x-bind:class="{ 'active-tab': active === 0 }" href="#" class="tab active-tab"></a>
    </div>
    <div class="tab-panels">
        <div x-bind:class="{ 'active-tab': active === 0 }" class="tab-panel active-tab"></div>
    </div>
</div>`;
...
JSPLib.menu.mainSettingsClick = function (override) {
    ...
    if (override || !JSPLib.utility.isNamespaceBound({root: this.settings_selector, eventtype: 'click', namespace: 'jsplib'})) {
...
JSPLib.menu.otherSettingsClicks = function (override) {
    ...
    if (override || !JSPLib.utility.isNamespaceBound({root: this.other_selectors, eventtype: 'click', namespace: 'jsplib'})) {
...
JSPLib.menu.installSettingsMenu = function () {
    ...
    if (jQuery("#userscript-settings-menu").length === 0) {
        ...
        jQuery('.tab-panels').append(SETTINGS_FIELD);
