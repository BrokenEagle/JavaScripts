...
JSPLib.menu.installSettingsMenu = function () {
    ...
    settings_tabs.push(jQuery(`<span class="jsplib-tab" data-name="${JSPLib.program_id}">${JSPLib.program_name}</span>`).get(0));
    settings_panels.push(jQuery(`<div id="${JSPLib.program_id}" class="jsplib-section" data-name="${JSPLib.program_id}"></div>`).get(0));
