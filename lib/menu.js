...
JSPLib.menu.preloadScript = function (self, program_value, {render_menu_func = null, run_on_settings = false, default_data = {}, reset_data = {}, initialize_func = null, broadcast_func = null, menu_css = null, program_css = null, danbooru_userscript = true} = {}) {
...
JSPLib.menu.updateUserSettings = function () {
    ...
    JSPLib._jQuery(`#${program_shortcut}-settings .${program_shortcut}-setting[id]`).each((_, entry) => {
...
JSPLib.menu.updateGlobalSettings = function () {
    ...
    JSPLib._jQuery(`#${program_shortcut}-settings .${program_shortcut}-global[id]`).each((_, entry) => {
        let $input = JSPLib._jQuery(entry);
        let parent_level = $input.data('parent');
        let container = JSPLib.utility.getNthParent(entry, parent_level);
        let setting_name = JSPLib._jQuery(container).data('setting');
