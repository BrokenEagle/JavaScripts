...
JSPLib.concurrency.checkSemaphore = function (name) {
    let storage_name = this._getSemaphoreName(name, true);
...
JSPLib.concurrency.setupMutationReplaceObserver = function ($root_node, remove_selector, func, disconnect = true) {
...
JSPLib.concurrency.whenScrolledIntoView = function (selector, options = {}) {
...
JSPLib.concurrency._getSemaphoreName = function (name, storage = true) {
