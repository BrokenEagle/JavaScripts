...
JSPLib.storage.pruneEntries = function (modulename,regex,prune_expires,database=JSPLib.storage.danboorustorage) {
    ...
    if (!JSPLib.storage._validateExpires(expires,prune_expires)) {
        ...
        JSPLib.storage.setStorageData(expire_name, JSPLib.storage._getExpiration(adjusted_prune_expires), localStorage);
        return promise_resp;
    } else {
...
JSPLib.storage._getExpiration = function (expires) {
