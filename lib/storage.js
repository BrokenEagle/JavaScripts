...
JSPLib.storage.getLocalData = function (key, {default_val = null} = {}) {
    return JSPLib.getStorageData(key, localStorage, {default_val});
};
...
JSPLib.storage.retrieveData = async function (self, key, {database = JSPLib.storage.danboorustorage} = {}) {
    if (!(this.use_storage)) {
        return null;
    }
...
JSPLib.storage.checkLocalData = function (key, validator, {default_val = null} = {}) {
    return this.checkStorageData(key, validator, localStorage, {default_val});
};

JSPLib.storage.checkSessionData = function (key, validator, {default_val = null} = {}) {
    return this.checkStorageData(key, validator, sessionStorage, {default_val});
};
