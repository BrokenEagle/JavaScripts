...
JSPLib.storage.checkIndexedSessionData = function (key, {validator = JSPLib.storage.localSessionValidator, default_val = null, database = JSPLib.storage.danboorustorage} = {}) {
    let session_key = this._getSessionKey(key, database);
    return this.checkSessionData(session_key, {validator, default_val});
};
