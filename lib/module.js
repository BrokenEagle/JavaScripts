...
JSPLib.debug = {};
['debuglog', 'debugwarn', 'debugerror', 'debuglogLevel', 'debugwarnLevel', 'debugerrorLevel', 'recordTime', 'recordTimeEnd', 'debugTime', 'debugTimeEnd', 'debugExecute', 'getFunctionPrint'].forEach((debugfunc) => {
...
Object.defineProperty(JSPLib, 'program_shortcut', {
    ...
    set(shortcut) {
        ...
        ['click', 'keydown', 'submit', 'change', 'navigate', 'focus', 'blur', 'scroll', 'mouseenter', 'mouseleave', 'mouseover', 'input', 'beforeunload', 'visibilitychange', 'dialogopen', 'dialogclose'].forEach((type) => {
            this[`program_${type}`] = `${type}.${shortcut}`;
        });
