...
JSPLib.initializeModule(null, {
    nonwritable: ['_active_script', '_sandboxed', '_page_context', '_window', '_document', '_gm_info', '_current_subdomain', '_window_jsp', 'event', 'jQueryProxy', 'DanbooruProxy', 'ValidateJS', 'UID', 'info', 'program']
});
