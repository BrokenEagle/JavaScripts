...
JSPLib.writeOnceReadMany = function (module, name, default_value) {
...
JSPLib.writeOnceReadMany(JSPLib, 'settings_config', {});
JSPLib.writeOnceReadMany(JSPLib, 'default_data', {});
JSPLib.writeOnceReadMany(JSPLib, 'reset_data', {});
JSPLib.writeOnceReadMany(JSPLib, 'data_regex', null);
...
JSPLib.initializeModule(null, [
    ...
    '_window_jsp', 'event', 'jQueryProxy', 'DanbooruProxy', 'ValidateJS', 'UID', 'info', 'program'
]);
