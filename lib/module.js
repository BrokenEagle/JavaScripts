...
JSPLib.debug.addModuleLogs = function (name,funclist) {
    funclist.forEach((f)=>{
        const func = JSPLib[name][f];
        func.debuglogLevel = func.debugwarnLevel = func.debugerrorLevel = (()=>{});
        JSPLib[name][f] = function (...args) {return func.apply(this, [func].concat(args));}});
};
