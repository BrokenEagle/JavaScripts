...
JSPLib.notice.installBanner = function (program_shortcut) {
    ...
    JSPLib.notice.banner_installed = true;
};

//Debug functions

JSPLib.notice.debugNotice = function(...args) {
    JSPLib.notice._noticeOutput(this.notice,...args);
};

JSPLib.notice.debugError = function(...args) {
    JSPLib.notice._noticeOutput(this.error,...args);
};

JSPLib.notice.debugNoticeLevel = function(...args) {
    JSPLib.notice._noticeOutputLevel(this.notice,...args);
};

JSPLib.notice.debugErrorLevel = function(...args) {
    JSPLib.notice._noticeOutputLevel(this.error,...args);
};
...
JSPLib.notice._notice = function (msg,append=true,permanent=false) {
