...
JSPLib.notice.installBanner = function () {
    let notice_banner = `<div id="${JSPLib.program_shortcut}-notice"><span>.</span><a href="#" id="${JSPLib.program_shortcut}-close-notice-link">close</a></div>`;
    ...
    JSPLib._jQuery(`#${JSPLib.program_shortcut}-close-notice-link`).on(JSPLib.program_click, this.closeNotice());
...
/****INITIALIZATION****/
Object.defineProperty(JSPLib.notice, 'danbooru_installed', {get() {return this._danbooru_installed || (this._danbooru_installed = this._is_danbooru_installed());}});
